...
- **Casbin RBAC on Postgres** — permission rules and group membership management backed by [`sqlx-adapter`](https://crates.io/crates/sqlx-adapter)
...
database_url = "postgres://user:pass@localhost/rust_api"
