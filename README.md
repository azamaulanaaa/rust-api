...
│   ├── wal.rs           Wal on OxKvStore — WalOp::{PolicyRuleAdd/Remove,GroupAdd/Remove/Delete,Attach,Detach,FileCreate,FileDelete} (+ legacy PolicyAdd/Remove marks), wal:{seq:020} + wal:seq, serialized appends
